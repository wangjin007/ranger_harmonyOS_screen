...
export const startClient: (hosts: string, port: number, width: number, height: number, fps: number, bitrate: number,
  displayId: number, rotationDeg: number, pin: number) => number;
